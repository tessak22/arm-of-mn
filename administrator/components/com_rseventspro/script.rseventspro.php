...
<div id="installer-right">
	...
	<?php if ($messages['modules']) { ?>
		...
		<?php } ?>
	<?php } ?>
	<h2>Changelog v1.8.24</h2>
	<ul class="version-history">
		<li><span class="version-fixed">Fix</span> Facebook all day events were not being imported correctly.</li>
		<li><span class="version-fixed">Fix</span> Event image from Facebook was not attributed to correct event.</li>
		<li><span class="version-fixed">Fix</span> No longer creating duplicate events when importing from Facebook.</li>
		<li><span class="version-fixed">Fix</span> Small CSS adjustments.</li>
		<li><span class="version-fixed">Fix</span> Query error when editing Groups.</li>
		<li><span class="version-fixed">Fix</span> More detailed messages are now shown when importing from Facebook.</li>
	</ul>
