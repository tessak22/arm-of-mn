...
function rsepro_change_list(val) {
	if (jQuery('#jform_params_archived').parent().parent().hasClass('control-group')) {
...
function rs_ideal(val) {
	if (jQuery('#jform_ideal_account').parent().parent().hasClass('control-group')) {
		jQuery('#jform_ideal_merchantid').parent().parent().css('display','');
		jQuery('#jform_ideal_subid').parent().parent().css('display','');
		jQuery('#jform_ideal_hashkey').parent().parent().css('display','');
		jQuery('#jform_ideal_abnamroid').parent().parent().css('display','');
		jQuery('#jform_ideal_ing_cer').parent().parent().css('display','');
		jQuery('#jform_ideal_ing_pem').parent().parent().css('display','');
		jQuery('#jform_ideal_rabo_cer').parent().parent().css('display','');
		jQuery('#jform_ideal_rabo_pem').parent().parent().css('display','');
		
		if (val == 'mollie') {
			jQuery('#jform_ideal_subid').parent().parent().css('display','none');
			jQuery('#jform_ideal_hashkey').parent().parent().css('display','none');
			jQuery('#jform_ideal_abnamroid').parent().parent().css('display','none');
			jQuery('#jform_ideal_ing_cer').parent().parent().css('display','none');
			jQuery('#jform_ideal_ing_pem').parent().parent().css('display','none');
			jQuery('#jform_ideal_rabo_cer').parent().parent().css('display','none');
			jQuery('#jform_ideal_rabo_pem').parent().parent().css('display','none');
			...
			jQuery('#jform_ideal_merchantid').parent().parent().css('display','none');
			jQuery('#jform_ideal_subid').parent().parent().css('display','none');
			jQuery('#jform_ideal_hashkey').parent().parent().css('display','none');
			jQuery('#jform_ideal_ing_cer').parent().parent().css('display','none');
			jQuery('#jform_ideal_ing_pem').parent().parent().css('display','none');
		...
		jQuery('#jform_ideal_merchantid').parent().css('display','');
		jQuery('#jform_ideal_subid').parent().css('display','');
		jQuery('#jform_ideal_hashkey').parent().css('display','');
		jQuery('#jform_ideal_abnamroid').parent().css('display','');
		jQuery('#jform_ideal_ing_cer').parent().css('display','');
		jQuery('#jform_ideal_ing_pem').parent().css('display','');
		jQuery('#jform_ideal_rabo_cer').parent().css('display','');
		jQuery('#jform_ideal_rabo_pem').parent().css('display','');
		
		if (val == 'mollie') {
			jQuery('#jform_ideal_subid').parent().css('display','none');
			jQuery('#jform_ideal_hashkey').parent().css('display','none');
			jQuery('#jform_ideal_abnamroid').parent().css('display','none');
			jQuery('#jform_ideal_ing_cer').parent().css('display','none');
			jQuery('#jform_ideal_ing_pem').parent().css('display','none');
			jQuery('#jform_ideal_rabo_cer').parent().css('display','none');
			jQuery('#jform_ideal_rabo_pem').parent().css('display','none');
		} else if (val == 'ingbasic' || val == 'rabobanklite') {
			jQuery('#jform_ideal_abnamroid').parent().css('display','none');
			jQuery('#jform_ideal_ing_cer').parent().css('display','none');
			jQuery('#jform_ideal_ing_pem').parent().css('display','none');
			...
			jQuery('#jform_ideal_merchantid').parent().css('display','none');
			jQuery('#jform_ideal_subid').parent().css('display','none');
			jQuery('#jform_ideal_hashkey').parent().css('display','none');
			jQuery('#jform_ideal_ing_cer').parent().css('display','none');
			jQuery('#jform_ideal_ing_pem').parent().css('display','none');
