					...
					<tr>
						...
						<td>
							<div>
								...
								<br />
								<b>"Event with multiple categories","<?php echo $now; ?>","<?php echo $endthree; ?>","Event Description","Event URL","Event Email","Event Phone","Location Name","Location address","First category|Second category|Third category","First category description|Second description|Third description"</b>
							</div>
						</td>
					</tr>
					<tr>
