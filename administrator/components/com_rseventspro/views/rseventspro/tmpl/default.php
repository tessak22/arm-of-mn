	...
	<div class="width-<?php echo $this->middle ? 30 : 70; ?> fltlft">
		<div class="dashboard-container">
			...
			<div class="rsspan2">
				<div class="dashboard-wraper">
					<div class="dashboard-content"> 
						<a href="<?php echo JRoute::_('index.php?option=com_rseventspro&view=categories'); ?>"> 
			...
			<div class="rsspan2">
				<div class="dashboard-wraper">
					<div class="dashboard-content"> 
						<a href="<?php echo JRoute::_('index.php?option=com_rseventspro&view=backup'); ?>"> 
							<img src="<?php echo JURI::root(); ?>administrator/components/com_rseventspro/assets/images/dashboard/backup.png" alt="<?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_BACKUP'); ?>" />
							<span class="dashboard-title"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_BACKUP'); ?></span> 
						</a> 
					</div>
				</div>
			</div>
			<div class="rsspan2">
				<div class="dashboard-wraper">
					<div class="dashboard-content"> 
						<a href="<?php echo JRoute::_('index.php?option=com_rseventspro&view=messages'); ?>"> 
							<img src="<?php echo JURI::root(); ?>administrator/components/com_rseventspro/assets/images/dashboard/emails.png" alt="<?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_EMAILS'); ?>" />
							<span class="dashboard-title"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_EMAILS'); ?></span> 
						</a> 
					</div>
				</div>
			</div>
