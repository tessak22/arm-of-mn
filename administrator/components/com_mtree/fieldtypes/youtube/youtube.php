...
class mFieldType_youtube extends mFieldType {
	...
	function getOutput($view=1) {
        ...
        $params['youtubeParameters'] = $this->getParam('youtubeParameters','showinfo=0&modestbranding=1&controls=0&rel=0');
        ...
        $html .= '?'.'showinfo=0&modestbranding=1&controls=0&rel=0';
