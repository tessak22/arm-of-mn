...
class HTML_mtcustomfields {
	...
	function updateInputs(ftype) {
		...
		if (ftype=='coreprice'||ftype=='coreaddress'||ftype=='coreaddress'||ftype=='corepostcode'||ftype=='corecontactperson'||ftype=='coremobile'||ftype=='coredate'||ftype=='coreyear'||ftype=='coretelephone'||ftype=='corefax'||ftype=='coreemail'||ftype=='corewebsite'||ftype=='corename'||ftype=='coredesc'||ftype=='coremetakey'||ftype==''||ftype=='coremetadesc'||ftype=='corecountry'||ftype=='corestate'||ftype=='corecity'<?php
		foreach( $custom_cf_types AS $custom_cf_type ) {
