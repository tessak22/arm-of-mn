...
if ($showhelp == 1)
{
	...
	$menu->addChild(new JMenuNode(JText::_('Windmill Documentation'), 'https://docs.google.com/document/d/13cuVFOzLtlKj0Ohu8WTqIeDWvWGpMYu0ZMq7Woj4sCo/edit?usp=sharing', 'class:help', false, '_blank'));

	$menu->addSeparator();

	$menu->addChild(new JMenuNode(JText::_('User Manager'), '/administrator/index.php?option=com_users&view=users', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Membership Manager'), '/administrator/index.php?option=com_rsmembership&view=subscribers', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Member Directory'), '/administrator/index.php?option=com_mtree', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Event Articles'), '/administrator/index.php?option=com_content&view=articles&filter_category_id=8', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Event Registration Setup'), '/administrator/index.php?option=com_rseventspro&view=events', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Obtain Register Link (Frontend)'), '/events/event-registration', 'class:help', false, '_blank'));
	$menu->addChild(new JMenuNode(JText::_('Featured Projects'), '/administrator/index.php?option=com_form2content&view=forms', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Homepage Custom Content Box'), '/administrator/index.php?option=com_modules&view=module&layout=edit&id=87', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Homepage Featured Project Box'), '/administrator/index.php?option=com_modules&view=module&layout=edit&id=91', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Footer Logos'), '/administrator/index.php?option=com_modules&filter_search=logo', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Footer Features'), '/administrator/index.php?option=com_modules&filter_search=feature', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Embedding Video & Audio'), 'https://docs.google.com/spreadsheets/u/1/d/1LCtr3vvNXrLaok1LJIe_mFY6SmOTqSDU5NKKfAtuyGU/pub?hl=en_US&hl=en_US&single=true&gid=0&output=html&widget=true
', 'class:help', false, '_blank'));
	$menu->addChild(new JMenuNode(JText::_('Multiple Column Example'), '/administrator/index.php?option=com_content&filter_search=column', 'class:help'));
	$menu->addChild(new JMenuNode(JText::_('Manage Event Photos'), '/administrator/index.php?option=com_sigpro&view=gallery&type=site&folder=event-photos&tmpl=index&editorName=', 'class:help'));
	$menu->getParent();
}
