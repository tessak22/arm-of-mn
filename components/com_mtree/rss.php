...
function rss( $option, $type, $cat_id=0 ) {
	...
	$core_fields = array( 'cat_name', 'cat_url', 'link_votes', 'link_rating', 'address', 'city', 'postcode', 'state', 'country', 'email', 'website', 'contactperson', 'mobile', 'date', 'year', 'telephone', 'fax', 'metakey', 'metadesc', 'lat', 'lng', 'zoom' );
