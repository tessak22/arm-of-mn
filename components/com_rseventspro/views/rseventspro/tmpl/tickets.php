	...
	<div id="draggable<?php echo $ticket->id; ?>" class="draggable rsepro_front ui-widget-content" style="<?php echo $style; ?>">
		<div class="rsepro_ticket_container">
			<div class="rsepro_ticket_name">
				...
				<img src="<?php echo JURI::root(); ?>components/com_rseventspro/assets/images/information.png" alt="" class="<?php echo rseventsproHelper::tooltipClass(); ?>" title="<?php echo rseventsproHelper::tooltipText($ticket->description); ?>" />
				<?php } ?>
			</div>
		</div>
