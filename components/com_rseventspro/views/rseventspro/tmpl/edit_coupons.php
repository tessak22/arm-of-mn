...
<div class="tab-pane" id="rsepro-edit-coupon<?php echo $coupon->id; ?>">
	...
	<div class="form-actions">
		<button class="btn btn-danger rsepro-event-remove-coupon" type="button" data-id="<?php echo $coupon->id; ?>"><span class="icon-remove"></span> <?php echo JText::_('COM_RSEVENTSPRO_REMOVE_COUPON'); ?></button>
