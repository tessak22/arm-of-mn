 ...
 */
class RSEPROFacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class RSEPROBaseFacebook
{
  /**
   * Version.
   */
  ...
  public function setExtendedAccessToken() {
    ...
    catch (RSEPROFacebookApiException $e) {
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new RSEPROFacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new RSEPROFacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
